...
class AboutFragment : MaterialAboutFragment() {
    ...
    companion object {
        ...
        private val REPOSITORY_LINK = HttpUrl.Builder()
                ...
                .build()
        private val SUPPORT_LINK = HttpUrl.Builder()
                .scheme("https")
                .host("proxer.me")
                .addPathSegment("forum")
                .addPathSegment("anwendungen")
                .addPathSegment("374605-opensource-android-proxer-app-fuer-android")
                .addQueryParameter("device", "mobile")
                .build()
        private val DEVELOPER_PROXER_NAME = "RubyGee"
        private val DEVELOPER_PROXER_ID = "121658"
        private const val DEVELOPER_PROXER_IMAGE = "121658_cEBC8F.png"
        private val DEVELOPER_GITHUB_NAME = "rubengees"
                ...
                MaterialAboutActionItem.Builder()
                        ...
                        .setOnClickListener {
                            LibsBuilder().withAutoDetect(false)
                                    ...
                                    .withActivityTitle(getString(R.string
                                            .about_info_licences_activity_title))
                                    .start(context)
                        }.build(),
                MaterialAboutActionItem.Builder()
        ...
        return listOf(
                ...
                MaterialAboutActionItem.Builder()
                        ...
                        .icon(ContextCompat.getDrawable(context, R.drawable.ic_stat_proxer).apply {
                            setColorFilter(ContextCompat.getColor(context, R.color.icon),
