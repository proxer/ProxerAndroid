...
object ErrorUtils {
    ...
    private val API_ERRORS = arrayOf(
        UNKNOWN_API, API_REMOVED, INVALID_API_CLASS, INVALID_API_FUNCTION,
    ...
    private val LOGIN_ERRORS = arrayOf(
        INVALID_TOKEN, NOTIFICATIONS_LOGIN_REQUIRED, UCP_LOGIN_REQUIRED,
        INFO_LOGIN_REQUIRED, MESSAGES_LOGIN_REQUIRED, USER_2FA_SECRET_REQUIRED
    )
    private val CLIENT_ERRORS = arrayOf(
        NEWS, LOGIN_MISSING_CREDENTIALS, UCP_INVALID_CATEGORY, INFO_INVALID_TYPE,
    ...
    private val INVALID_ID_ERRORS = arrayOf(
        USERINFO_INVALID_ID, UCP_INVALID_ID, INFO_INVALID_ID, MEDIA_INVALID_ENTRY,
    ...
    private val UNSUPPORTED_ERRORS = arrayOf(
        USER, AUTH_INVALID_USER, AUTH_CODE_ALREADY_EXISTS,
